...
public class loginController implements Initializable {
    ...
    public void onLogin(ActionEvent actionEvent) {
        try {
            ...
            if (resultSet.next()) {
                ...
                loginController.setUserCredentials(enteredUsername, enteredPassword);
                ...
                loginController.setUserDetails(kund_Id,name_F, name_E, email, phone, address, age, kund_Typ);
            } else {
    ...
    private void setUserCredentials(String enteredUsername, String enteredPassword) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'setUserCredentials'");
    }


    private void setUserDetails(int kund_Id, String name_F, String name_E, String email, String phone, String address,
            int age, String kund_Typ) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'setUserDetails'");
    }
